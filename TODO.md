...
_Обновлено: 2026-07-06 (продолжение сессии — Фаза B GUI-фичи)_
...
6 новых тестов, итого 286 проходят. Осталось: единый API + бот (Фаза C),
редактирование существующих тренировок в Конструкторе, простой/экспертный режим.
