...
_Обновлено: 2026-07-07 (продолжение сессии — Фаза C: единый Plan API)_
...
### Простой/экспертный режим интерфейса
Обсуждено давно, не начато — скрыть YAML/CLI-детали от обычного пользователя за переключателем.
